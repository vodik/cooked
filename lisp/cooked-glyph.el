...
(defun cooked--bitmap-fill-axis (bitmap axis along0 along1 across0 across1 &optional clear)
  "Fill the rectangle ALONG0..ALONG1 by ACROSS0..ACROSS1, oriented by AXIS.
...
(defun cooked--bitmap-stroke (bitmap axis along0 along1 center thickness)
  "Draw a THICKNESS-wide band along AXIS from ALONG0 to ALONG1, centred on CENTER.
...
(defun cooked--box-draw-dashes (bitmap axis count)
  "Break an already-drawn stroke running along AXIS into COUNT dashes.
